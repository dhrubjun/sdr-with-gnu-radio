...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Exploring FM Sidebands", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Exploring FM Sidebands")
