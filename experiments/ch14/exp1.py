...
class exp1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Frequency Modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Frequency Modulation")
        ...
        self._freq_dev_range = qtgui.Range(0, 5000, 250, 2000, 200)
        ...
        labels = ['Message', 'FM Signal', 'Signal 3', 'Signal 4', 'Signal 5',
