...
# Title: Adaptive LMS Equalization with noise
# Author: Dhrubjun
...
class exp4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Adaptive LMS Equalization with noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Adaptive LMS Equalization with noise")
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'Adaptive LMS Equalization (Noise amplitude = 0.8)', #name
            2, #number of inputs
            None # parent
        )
