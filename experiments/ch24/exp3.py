...
# Title: Demonstrating Subcarrier Orthogonality
# Author: Dhrubjun
...
class exp3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Demonstrating Subcarrier Orthogonality", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demonstrating Subcarrier Orthogonality")
        ...
        self._f2_range = qtgui.Range(1000, 3000, 50, 2000, 200)
        self._f2_win = qtgui.RangeWidget(self._f2_range, self.set_f2, "Second Subcarrier Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._f2_win)
        ...
        self.qtgui_number_sink_0.set_title('Subcarrier Correlation Magnitude')

        labels = ['Correlation Magnitude', '', '', '', '',
            '', '', '', '', '']
        units = ['', '', '', '', '',
            '', '', '', '', '']
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            'Relative Subcarrier Frequency', #name
            1,
            None # parent
        )
        self.qtgui_freq_sink_x_0.set_update_time(0.10)
        self.qtgui_freq_sink_x_0.set_y_axis((-140), 2)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_multiply_conjugate_cc_0, 1))
