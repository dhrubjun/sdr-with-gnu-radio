...
# Title: Complete Single-Carrier Receiver
...
import exp4_epy_block_0 as epy_block_0  # embedded python block
import math
import sip
import threading
...
class exp4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Complete Single-Carrier Receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Complete Single-Carrier Receiver")
