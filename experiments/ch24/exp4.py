...
# Title: Recovering Data from Orthogonal Subcarriers
# Author: Dhrubjun
...
class exp4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Recovering Data from Orthogonal Subcarriers", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Recovering Data from Orthogonal Subcarriers")
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'Recovered Subcarrier 1 (Orthogonal: Δf = 750 Hz)', #name
            1, #number of inputs
            None # parent
        )
