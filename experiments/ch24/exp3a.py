...
# Title: Multipath before equalization
# Author: Dhrubjun
...
class exp3a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Multipath before equalization", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Multipath before equalization")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "exp3a")
...
def main(top_block_cls=exp3a, options=None):
