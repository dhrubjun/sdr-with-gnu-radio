"""
Experiment 24.4 - Complete Single-Carrier Receiver
Payload Decoder

Collects the 24 payload bits following a frame_start tag,
converts the three 8-bit groups to ASCII, and prints the
recovered payload.

This script performs payload extraction and display only.
Receiver synchronization and symbol recovery are performed
by the GNU Radio flowgraph.
"""
