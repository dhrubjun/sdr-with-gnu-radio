...
# Title: Integrated QPSK Receiver: Carrier and Timing Recovery
# Author: Dhrubjun
...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Integrated QPSK Receiver: Carrier and Timing Recovery", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Integrated QPSK Receiver: Carrier and Timing Recovery")
