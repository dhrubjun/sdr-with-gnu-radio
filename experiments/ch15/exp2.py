...
# Title: Bit Rate and Bit Duration
# Author: Dhrubjun
...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Bit Rate and Bit Duration", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Bit Rate and Bit Duration")
        ...
        labels = ['Bit Waveform', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
