...
class exp1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "A Digital Data Stream", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("A Digital Data Stream")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            512, #size
            samp_rate, #samp_rate
            'Bits as a Physical Waveform', #name
            1, #number of inputs
            None # parent
        )
