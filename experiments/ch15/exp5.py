...
class exp5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Mapping Bits to Symbols", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Mapping Bits to Symbols")
