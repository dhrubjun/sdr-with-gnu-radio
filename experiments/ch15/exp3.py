...
class exp3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, " From Bits to Symbols", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle(" From Bits to Symbols")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            512, #size
            samp_rate, #samp_rate
            'Grouped Symbol Values', #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_time_sink_x_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0.set_y_axis(-0.2, 4)
