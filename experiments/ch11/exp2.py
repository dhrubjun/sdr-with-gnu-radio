...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Shifted Pattern", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Shifted Pattern")
        ...
        labels = ['Received Sequence', 'Correlation Output', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((0,)*20 + (1, -1, -1, 1) + (0,)*76, False, 1, [])
