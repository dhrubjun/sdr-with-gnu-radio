...
class exp3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Mismatched Pattern", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Mismatched Pattern")
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((0,)*10 + (1, 1, -1, 1) + (0,)*26, True, 1, [])
