...
class exp6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'QPSK through Channel Model', #name
            1, #number of inputs
            None # parent
        )
        ...
        self._freq_offset_hz_range = qtgui.Range(0, 100, 5, 0, 200)
        self._freq_offset_hz_win = qtgui.RangeWidget(self._freq_offset_hz_range, self.set_freq_offset_hz, "Frequency Offset (Hz)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_offset_hz_win)
