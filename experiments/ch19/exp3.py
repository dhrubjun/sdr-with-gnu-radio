...
class exp3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Attenuation and Noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Attenuation and Noise")
        ...
        self.channel_gain = channel_gain = 1
        ...
        self._channel_gain_range = qtgui.Range(0, 1, 0.1, 1, 200)
        self._channel_gain_win = qtgui.RangeWidget(self._channel_gain_range, self.set_channel_gain, "Channel Gain", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._channel_gain_win)
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'Attenuation and Noise', #name
            1, #number of inputs
            None # parent
        )
        ...
        self._noise_amp_range = qtgui.Range(0, 0.5, 0.01, 0, 200)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(channel_gain)
    ...
    def set_channel_gain(self, channel_gain):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.channel_gain)
