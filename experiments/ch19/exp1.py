...
class exp1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Clean Reference Link", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Clean Reference Link")
