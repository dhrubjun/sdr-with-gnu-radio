...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Channel Attenuation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Channel Attenuation")
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'Received QPSK with Attenuation', #name
            1, #number of inputs
            None # parent
        )
