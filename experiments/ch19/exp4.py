...
class exp4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Carrier Frequency Offset", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Carrier Frequency Offset")
        ...
        self._freq_offset_range = qtgui.Range(-200, 200, 5, 0, 200)
        self._freq_offset_win = qtgui.RangeWidget(self._freq_offset_range, self.set_freq_offset, "Grequency Offset", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_offset_win)
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'QPSK with Carrier Frequency Offset', #name
            1, #number of inputs
            None # parent
        )
