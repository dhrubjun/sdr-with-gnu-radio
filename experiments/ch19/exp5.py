...
class exp5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "One Delayed Copy", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("One Delayed Copy")
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'QPSK with One Delayed Copy', #name
            1, #number of inputs
            None # parent
        )
