...
class exp1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Noise", catch_exceptions=True)
        ...
        self.noise_ampl = noise_ampl = 1

        ##################################################
        # Blocks
        ##################################################

        self._noise_ampl_range = qtgui.Range(0, 2, 0.1, 1, 200)
        self._noise_ampl_win = qtgui.RangeWidget(self._noise_ampl_range, self.set_noise_ampl, "Noise Amplitude", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._noise_ampl_win)
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            '1 kHz Cosine + Gaussian Noise: Time Domain', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            '1 kHz Cosine + Gaussian Noise: Frequency Domain', #name
            1,
            None # parent
        )
        self.qtgui_freq_sink_x_0.set_update_time(0.10)
        self.qtgui_freq_sink_x_0.set_y_axis((-80), 5)
        ...
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, noise_ampl, 0)
