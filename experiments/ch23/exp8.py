...
class exp8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QPSK Frame Detection", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK Frame Detection")
        ...
        self._noise_voltage_range = qtgui.Range(0, 3, 0.05, 0, 200)
        ...
        self.digital_symbol_sync_xx_0 = digital.symbol_sync_cc(
            ...
            128,
            [])
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_bb('10110010', 0, 'frame_start')
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_vector_source_x_0_0 = blocks.vector_source_b([0, 1, 0, 0, 1, 0, 1, 1], True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_b([1, 1, 0, 1, 0, 1, 0, 0], True, 1, [])
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_char*1, 'Access Code Detection', 'frame_start')
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.digital_binary_slicer_fb_1, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.interp_fir_filter_xxx_0, 0))
        self.connect((self.blocks_head_0, 0), (self.blocks_tag_debug_0, 0))
        self.connect((self.blocks_interleave_0, 0), (self.digital_correlate_access_code_tag_xx_0, 0))
        ...
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.blocks_interleave_0, 0))
        self.connect((self.digital_binary_slicer_fb_1, 0), (self.blocks_interleave_0, 1))
        ...
        self.connect((self.digital_correlate_access_code_tag_xx_0, 0), (self.blocks_head_0, 0))
