...
# Title: Preamble Detection in Noise
...
class exp3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Preamble Detection in Noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Preamble Detection in Noise")
        ...
        labels = ['Correlation Magnitude', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
