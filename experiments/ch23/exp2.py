...
# Title: Detecting a Known Preamble with Correlation
...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Detecting a Known Preamble with Correlation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Detecting a Known Preamble with Correlation")
