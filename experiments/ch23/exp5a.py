...
# Title: Effect of Preamble Sequence
...
class exp5a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Effect of Preamble Sequence", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Effect of Preamble Sequence")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "exp5a")
        ...
        self.detection_threshold = detection_threshold = 11
        ...
        self._noise_voltage_range = qtgui.Range(0, 1, 0.05, 0, 200)
        ...
        self._detection_threshold_range = qtgui.Range(0, 20, 0.5, 11, 200)
        self._detection_threshold_win = qtgui.RangeWidget(self._detection_threshold_range, self.set_detection_threshold, "Detection Threshold", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._detection_threshold_win)
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            64, #size
            symbol_rate, #samp_rate
            'Correct 8-symbol preamble', #name
            3, #number of inputs
            None # parent
        )
        ...
        labels = ['Correlation Magnitude', 'Detection Output', 'Detection Threshold', 'Signal 4', 'Signal 5',
            'Signal 6', 'Signal 7', 'Signal 8', 'Signal 9', 'Signal 10']
        widths = [1, 2, 2, 1, 1,
            1, 1, 1, 1, 1]
        colors = ['red', 'green', 'black', 'black', 'cyan',
        ...
        self.fir_filter_xxx_1 = filter.fir_filter_ccc(1, [1-1j, 1+1j, -1-1j, -1+1j, 1-1j, 1+1j, -1-1j, -1+1j])
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff((detection_threshold-1), detection_threshold, 0)
        self.blocks_keep_one_in_n_0 = blocks.keep_one_in_n(gr.sizeof_gr_complex*1, sps)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, detection_threshold)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.qtgui_time_sink_x_1, 2))
        ...
        self.connect((self.blocks_keep_one_in_n_0, 0), (self.fir_filter_xxx_1, 0))
    ...
    def set_detection_threshold(self, detection_threshold):
        ...
        self.analog_const_source_x_0.set_offset(self.detection_threshold)
        self.blocks_threshold_ff_0.set_hi(self.detection_threshold)
        self.blocks_threshold_ff_0.set_lo((self.detection_threshold-1))
...
def main(top_block_cls=exp5a, options=None):
