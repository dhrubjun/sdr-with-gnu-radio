...
class exp5b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "exp5b")
        ...
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            ...
            'Shorter 4-symbol preamble', #name
            3, #number of inputs
            None # parent
        )
        ...
        self.fir_filter_xxx_1 = filter.fir_filter_ccc(1, [1-1j, 1+1j, -1-1j, -1+1j])
...
def main(top_block_cls=exp5b, options=None):
