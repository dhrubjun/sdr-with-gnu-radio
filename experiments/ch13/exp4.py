...
# Title: Conventional AM vs DSB-SC
# Author: Dhrubjun
...
class exp4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Conventional AM vs DSB-SC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Conventional AM vs DSB-SC")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, message_freq, 1, 0, 0)
