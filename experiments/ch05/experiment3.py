...
class experiment3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Experiment 3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Experiment 3")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "experiment3")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            256, #size
            samp_rate, #samp_rate
            'I and Q Baseband Components', #name
            2, #number of inputs
            None # parent
        )
        ...
        labels = ['I (In-phase)', 'Q (Quadrature)', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            'Complex Baseband Spectrum', #name
            1,
            None # parent
        )
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 8000, (-1), 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 8000, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 4000, 2000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 4000, 2000, window.WIN_HAMMING, 6.76))
