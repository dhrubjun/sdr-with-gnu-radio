...
# Title: Single Symbol Pulse Spreading
# Author: Dhrubjun
...
class exp3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Single Symbol Pulse Spreading", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Single Symbol Pulse Spreading")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            256, #size
            samp_rate, #samp_rate
            'Single Symbol Before and After Smoothing', #name
            2, #number of inputs
            None # parent
        )
        ...
        labels = ['Rectangular Pulse', 'Filtered Pulse', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((1, -1, 1, 1, -1, 1, -1, -1), True, 1, [])
