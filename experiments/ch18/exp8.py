...
# Title: Matched Filtering in Noise
# Author: Dhrubjun
...
class exp8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Matched Filtering in Noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Matched Filtering in Noise")
