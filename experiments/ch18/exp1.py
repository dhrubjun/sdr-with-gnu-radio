...
# Title: Rectangular Symbols and Bandwidth
# Author: Dhrubjun
...
class exp1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Rectangular Symbols and Bandwidth", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rectangular Symbols and Bandwidth")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            512, #size
            samp_rate, #samp_rate
            'Rectangular BPSK Symbol Waveform', #name
            1, #number of inputs
            None # parent
        )
        ...
        labels = ['BPSK Symbols', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Spectrum of Rectangular BPSK Symbols', #name
            1,
            None # parent
        )
