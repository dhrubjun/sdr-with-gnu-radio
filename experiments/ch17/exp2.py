...
# Title: Seeing the BPSK Phase Shift
# Author: Dhrubjun
...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Seeing the BPSK Phase Shift", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Seeing the BPSK Phase Shift")
        ...
        self.carrier_freq = carrier_freq = 4000
        ...
        labels = ['Reference Carrier', 'BPSK Carrier', 'Signal 3', 'Signal 4', 'Signal 5',
