...
class chapter02(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Beats", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Beats")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "chapter02")
        ...
        labels = ['x1 (1000 Hz)', 'x1 + x2', 'x2 (1050 Hz)', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1050, 1, 0, 0)
        ...
        self.connect((self.blocks_throttle2_0_1, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_throttle2_0_1, 0), (self.qtgui_time_sink_x_0, 0))
...
def main(top_block_cls=chapter02, options=None):
