...
# Title: QPSK Carrier Recovery with Costas Loop
...
class exp7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QPSK Carrier Recovery with Costas Loop", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK Carrier Recovery with Costas Loop")
