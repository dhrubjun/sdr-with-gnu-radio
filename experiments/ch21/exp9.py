...
# Title: Effect of Carrier Frequency Offset
...
class exp9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Effect of Carrier Frequency Offset", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Effect of Carrier Frequency Offset")
        ...
        self.digital_fll_band_edge_cc_1 = digital.fll_band_edge_cc(4, 0.35, 45, 0)
