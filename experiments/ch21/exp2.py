...
class exp2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Conjugate Product", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Conjugate Product")
        ...
        self.qtgui_number_sink_0.set_title('Estimated Carrier Phase Offset')
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'Reference QPSK and Conjugate Product', #name
            2, #number of inputs
            None # parent
        )
        ...
        labels = ['Reference QPSK', 'Conjugate Product', '', '', '',
            '', '', '', '', '']
        widths = [5, 5, 1, 1, 1,
            1, 1, 1, 1, 1]
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff((180/math.pi))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(math.cos(math.radians(phase_offset)) + 1j*math.sin(math.radians(phase_offset)))
        ...
        self.connect((self.blocks_multiply_conjugate_cc_0, 0), (self.qtgui_const_sink_x_0, 1))
    ...
    def set_phase_offset(self, phase_offset):
        ...
        self.blocks_multiply_const_vxx_0.set_k(math.cos(math.radians(self.phase_offset)) + 1j*math.sin(math.radians(self.phase_offset)))
